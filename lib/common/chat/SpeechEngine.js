...
SpeechEngine.prototype.onSend = function(){
	...
	if(this.sForm.children("#ipt_message_box").val() == ""){return false;};
...
SpeechEngine.prototype.onReceive = function(message){
	...
	var message = $('<li class="li_message">').append(
			$('<span id="spn_username">').text("User Name - Language"),
